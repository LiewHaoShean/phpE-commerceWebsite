...
if(isset($_POST['insert_products'])){
    ...
    if($product_title=='' or $description=='' or $product_keywords=='' or $product_categories=='' or $product_brands=='' or $product_price=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
        echo"<scrip>alert('Please fill all the available fields')</script>";
        exit();
    }else{
    ...
    <div class="container mt-3">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_keywords" id="products_keywords" class="form-control" placeholder="Enter product keywords" autocomplete="off" required="required">
            </div>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                <select name="product_brands" id="" class="form-select">
                    ...
                    while($row_brand=mysqli_fetch_assoc($result_query_brand)){
            ...
            <!-- Image 3 -->
            <div class="form-outline mb-4 w-50 m-auto">
                <label for=product_image3 class="form-label">Product image 3
                </label><input type="file" name="product_image3" id="product_image3" class="form-control" required="required">
            </div>
            ...
            <!-- keywords-->
            <div class="form-outline mb-4 w-50 m-auto">
                <input type="submit" name="insert_products" id="products_keywords" class="btn btn-info mb-3 px-3" value="Insert Products">
            </div>
        </form>
    </div>
