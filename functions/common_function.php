    ...
    if (!isset($_GET['category'])) {
        ...
        <div class='card' style='height:400px;'>
            ...
            <div class='card-body'>
                ...
                <a href='product_details.php?product_id=$product_id' class='btn btn-secondary' name='related_products'>View more</a>
            </div>
        </div>
    </div>";
    ...
    if (!isset($_GET['category'])) {
        ...
        <div class='card' style='height:400px;'>
            ...
            <div class='card-body'>
                ...
                <p class='card-text'>Price: $product_price/-</p>
                <a href='index.php?add_to_cart=$product_id' class='btn btn-info'>Add to cart</a>
                <a href='index.php' class='btn btn-secondary' name='related_products'>Go home</a>
            </div>
        </div>
    </div>
    <div class='col-md-8'>
...
function cart(){
    if(isset($_GET['add_to_cart'])){
        ...
        if($num_of_rows> 0){
            ...
            echo "<script>alert('The iem is added to cart')</script>";
            echo "<script>window.open('index.php', '_self')</script>";
        }
    }
}
        ...
        if(!isset($_GET['edit_account'])){
            if(!isset($_GET['my_orders'])){
                if(!isset($_GET['delete_account'])){
                    ...
                    if($row_count> 0){
                        echo"
                            <h3 class='text-center text-success my-6'>You have <span class='text-danger'>$row_count</span> pending orders</h3>
                            <p class='text-center'><a href='profile.php?my_orders' class='text-dark'>Order Details</a></p>";
                    }else{
                        echo "
                        <h3 class='text-center text-success my-6'>You have no pending orders!</h3>
