<?php
    if(isset($_GET['edit_account'])){
        ...
        if(isset($_POST['user_update'])){
            ...
            //update query
            $update_data="update `user_table` set username='$username', user_email='$user_email', user_image='$user_image', user_address='$user_address', user_mobile='$user_mobile' where 
            user_id='$update_id'";
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4 d-flex w-50 m-auto">
            <input type="file" class="form-contro m-auto"
            name="user_image">
            <img src="./user_images/<?php echo $user_image?>" class="edit-image"alt="">
        </div>
        <div class="form-outline mb-4">
